...
const Feed = (() => {
  ...
  const _cardPost = (p, likeCount, cmtCount, liked) => {
    ...
    const img = p.video_url
      ...
      : (p.photo_url ? `<div class="card-img-wrap"><img src="${Utils.esc(p.photo_url)}" loading="lazy" style="width:100%;display:block;max-height:500px;object-fit:contain;background:#000;"></div>` : '')
